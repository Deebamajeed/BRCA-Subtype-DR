...
save_results_to = '/content/results/results1'
...
print('AB*************************************************************')
TCGAEx = pd.read_csv("/content/gdrive/MyDrive/multiomics/train_label_lumA_Basal.csv", 
...
#TCGAE = SelectKBest(chi2, k=300).fit_transform(x1, Y)
    ...
    for repeat in range(10):
        for train_index, test_index in skf.split(TCGAE, Y.astype('int')):
            ...
            if k%50==0:
                ...
                title='LumA-vs-LumB-ROC(A=1,B=0)-skf10 '
                plt.suptitle(title)
                plt.savefig(save_results_to + title + '.png', dpi = 150)
                plt.close()
                ...
                title = 'LumA-vs-LumB_ Cost(A=1,B=0)-skf10   mb_size = {},  h_dim = {} , lrE = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}'.\
                ...
                title = 'LumA_vs_LumB_ AUC(A=1,B=0)-skf10  mb_size = {},  h_dim = {},  lrE = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}, '.\
                              format( mbs, hdm, lre, epch, rate, wd, lrCL)        
                ...
                plt.plot(np.squeeze(acctr25), '-r',np.squeeze(accts25), '-b')
                plt.ylabel('Accuracy')
                plt.xlabel('epoch')

                title = 'LumA_vs_LumB Accuracy(A=1,B=0)-skf10   mb_size = {},  h_dim = {},  lrE = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}, '.\
                              format( mbs, hdm, lre, epch, rate, wd, lrCL)        
                ...
                title = 'LumA_vs_LumB(A=1,B=0)-skf10   mb_size = {},  h_dim = {},  lrE = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}, '.\
                              format( mbs, hdm, lre, epch, rate, wd, lrCL)        
                ...
                title = 'LumA_vs_LumB_ specificity(A=1,B=0)-skf10  mb_size = {},  h_dim = {},  lrE = {}, epoch = {}, rate = {}, wd = {}, lrCL = {}, '.\
                              format( mbs, hdm, lre, epch, rate, wd, lrCL)        
